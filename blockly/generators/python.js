...
Blockly.Python.init = function(workspace) {
  ...
  Blockly.Python.ds_variables_ = Object.create(null);// Créé par Driss
  Blockly.Python.ds_codePython_ = Object.create(null);// Créé par Driss
...
Blockly.Python.finish = function(code) {
  ...
  //Ajouté par Driss
  var variables = []; 
  for (var name in Blockly.Python.ds_variables_) { 
    var var_g = Blockly.Python.ds_variables_[name];
    //alert("- "+name + "   - "+var_g);
    variables.push(var_g);
  }

  var codePython = []; 
  for (var name in Blockly.Python.ds_codePython_) { 
    var var_cp = Blockly.Python.ds_codePython_[name];
    //alert("- "+name + "   - "+var_cp);
    codePython.push(var_cp);
  }
  /*Fin Ajout Driss*/
  ...
  //Ajouté par Driss
  var functions = []; 
  for (var name in Blockly.Python.functionNames_) { 
    var fun = Blockly.Python.functionNames_[name];
    //alert("- "+name + "   - "+fun);
    functions.push(fun);
