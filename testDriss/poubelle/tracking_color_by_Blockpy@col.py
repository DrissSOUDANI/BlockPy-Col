...
couleurMinCutter = np.array([0, 163, 100])
couleurMaxCutter = np.array([18, 255, 255])
...
while True:
    ...
    imageBGR = VideoCapture_1.read()[1]
    ...
    imageMaskTotal = cv2.erode(imageMaskTotal, (1,1), iterations=4)

    imageMaskTotal = cv2.dilate(imageMaskTotal, (1,1), iterations=10)
