...
cv2.namedWindow(fenetreControle, cv2.WINDOW_AUTOSIZE)


# if not vCap.isOpened()q:
...
cv2.createTrackbar("V min ", fenetreControle , lo_S, 255, on_Lo_V_cursorSlide)
cv2.createTrackbar("V max ", fenetreControle , hi_S, 255, on_Hi_V_cursorSlide)
