...
/**
 * @fileoverview Les blocs de répétition (Loop) de Blockly
 * @author fraser@google.com (Neil Fraser) modifiés par Driss Soudani
 */
 'use strict';
...
Blockly.Blocks['controls_pass'] = {
    init: function() {
        ...
        this.appendDummyInput()
            .appendField(Blockly.Msg.CONTROLS_DO_NOTHING);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip("Ce bloc ne fait rien.");
    }
}
