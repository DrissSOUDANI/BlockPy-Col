...
Blockly.Blocks['driss_grove_button'] = {
    ...
    init: function() {
      ...
      this.appendDummyInput("")
          ...
          .appendField(new Blockly.FieldImage("./src/blockly_blocks/drissBlocks/drissGrove/Grove_button.png", 64,  64))
...
Blockly.Blocks['driss_grove_red_led'] = {
   ...
   init: function() {
     ...
     this.appendDummyInput("A")
         ...
         .appendField(new Blockly.FieldImage("./src/blockly_blocks/drissBlocks/drissGrove/Grove_red_LED.png", 64,  64), "IMA")
   ...
   onchange: function(ev) {
     ...
     this.getInput('A').removeField("IMA");
     this.getInput('A').appendField(new Blockly.FieldImage(image, 64,  64), "IMA")
   }
  };