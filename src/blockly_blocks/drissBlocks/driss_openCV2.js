...
Blockly.Blocks['driss_opencv2_wait_this_key_pressed'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField("a été pressée");
    this.appendDummyInput()
        .appendField("!! Attendre ici l'appui sur une touche !!");
    this.setOutput(true, null);
    this.setColour(30);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['driss_opencv2_trouver_contour_immatriculation'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Identifier la plaque d'immatriculation");
    this.appendDummyInput()
        .setAlign(Blockly.ALIGN_CENTRE)
        .appendField("dans l'image")
        .appendField(new Blockly.FieldVariable("variable"), "VAR_IMAGE");
...
Blockly.Blocks['driss_opencv2_nom_visage_reconnu'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .setAlign(Blockly.ALIGN_CENTRE)
        .appendField(new Blockly.FieldCheckbox("TRUE"), "CB_MARK_IN_PICTURE")
        .appendField("Afficher la photo et encadrer le visage");
    this.setInputsInline(false);
    this.setOutput(true, null);
    this.setColour(195);
 this.setTooltip("");
