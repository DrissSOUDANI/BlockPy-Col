...
Blockly.Msg.LISTS_APPEND = "Ajouter cet élément";  
Blockly.Msg.LISTS_APPEND_HELPURL = "http://google.com";  // untranslated
Blockly.Msg.LISTS_APPEND_TO = "à la liste";  
...
Blockly.Msg.PROCEDURES_BEFORE_PARAMS = "arguments :"; //"avec :"; //Modifié par Driss
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "nom de la fonction"; //"faire quelque chose"; //Modifié par Driss
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "fonction "; //"pour "; //Modifié par Driss
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "Crée une fonction sans retour.";//Modifié par Driss
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL = "https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";  // untranslated
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "retour";
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Crée une fonction avec un retour.";//Modifié par Driss
...
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = "nom de l'argument :"; //"nom de l’entrée :"; //Modifié par Driss
Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP = "Ajouter une entrée à la fonction.";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "les arguments de la fonction";//"entrées";//Modifié par Driss
...
Blockly.Msg.VARIABLES_SET = "faire %1 = %2";
...
/*Ajouts Driss*/
Blockly.Msg.LOGIC_IS_IN = "est dans";
Blockly.Msg.LOGIC_IS_NOT_IN = "n'est pas dans";

Blockly.Msg.CONTROLS_DO_NOTHING = "Ne rien faire";


Blockly.Msg.drissOpenCV_HUE = "#cc2828";
